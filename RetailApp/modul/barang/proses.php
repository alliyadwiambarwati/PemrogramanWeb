...
if ($_SERVER['REQUEST_METHOD']=="POST") {
    ...
    if($aksi == "tambah"){
        ...
        $sql = "UPDATE barang SET id_pemasok='$idpemasok', nama_barang='$namabarang', merk='$merk', ukuran='$ukuran', satuan='$satuan', 
        id_kategori='$idkategori', harga_beli='$hargabeli', harga_jual='$hargajual', deskripsi='$deskripsi' WHERE id_barang='$id'";
    }elseif($aksi == "hapus"){
        $id = $_GET['id'];
