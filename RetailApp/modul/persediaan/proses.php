...
if ($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    if($aksi == "stok-awal"){
        ...
        $deskripsi = $_POST['deskripsi'];
            ...
            $sql = "INSERT INTO persediaan (id_barang,stok_awal,stok_masuk,stok_keluar,stok_akhir
             ,deskripsi_persediaan) VALUES ('$barang','$stokawal','0','0','$stokawal','$deskripsi')";
        ...
        $stokakhir = $row_persediaan['stok_akhir'] + $stokmasuk;
              ...
              $sql = "UPDATE persediaan SET stok_awal='$stokawal', stok_masuk='$stokmasuk', stok_keluar=0
            , stok_akhir='$stokakhir', deskripsi_persediaan='$deskripsi' WHERE id_persediaan='$idpersediaan'";
        ...
        $stokakhir = $row_persediaan['stok_akhir'] - $stokkeluar;
              ...
              $sql = "UPDATE persediaan SET stok_awal='$stokawal', stok_masuk=0, stok_keluar='$stokkeluar'
            , stok_akhir='$stokakhir', deskripsi_persediaan='$deskripsi' WHERE id_persediaan='$idpersediaan'";
    }
    $mysqli->query($sql);
}
