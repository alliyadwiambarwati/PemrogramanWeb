            ...
            <div class="modal-content">
                ...
                <form action="modul/Kategori/proses.php?aksi=tambah" method="post">
                    <div class="modal-body">
                        <div class="mb-3">
                                <label for="namapemasok" class="form-label">Nama Kategori</label>
...
<table id="myTable">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
               <a href="" data-bs-toggle="modal" data-bs-target="#modalEdit<?$row_pemasok['id_kategori'];?>" class="text-info"><i class="bi bi-pencil-square"></i></a>
               <div class="modal fade" id="modalEdit<?$row_pemasok['id_kategori'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="status" class="form-select">
                                        ...
                                        <option value="0" <?=$row_kategori['status']==1?'selected':'';?>>Tidak Aktif</option>
                                    </select>
                                </div>
                            </div>
                            <div class="modal-footer">
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-footer">
                                ...
                                <form action="modul/kategori/proses.php?aksi=hapus&id=<?=$row_kategori['id_kategori'];?>" method="post">
                                    <button type="submit" class="btn btn-denger">Hapus</button>
                </form>
        </div>
        </div>
        </div>
