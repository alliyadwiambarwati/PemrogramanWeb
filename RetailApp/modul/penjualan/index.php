            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalBayarLabel">Bayar</h5>
...
<div class="row mt-3 shadow-sm">
    <div class="col-12">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <?php
                $sql_detailpenjualan = "SELECT * FROM detail_penjualan 
                ...
                <tr>
                    <td><?php  $no++; ?></td>
                    <td><?php $row_detailpenjualan['nama_barang']; ?></td>
                    <td><?php $row_detailpenjualan['jumlah']; ?></td>
                    <td>
                        <div class="d-flex justify-content-between">
                        <span>Rp.</span>
                        <span>
                        <?php number_format($row_detailpenjualan['harga'], 0, ',', '.'); ?></td>
                        </span>
                    </div>
                </td>
                <td>
                        ...
                        <span>Rp.</span>
                        <span>
                        <?php number_format($row_detailpenjualan['totalharga'], 0, ',', '.'); ?></td>
                        </span>
                    </div>
                </td>
